...
//HOLDS THE STORY DATA (IMAGE OF EACH PAGE AND THE CHOICES OF THE PAGES)
public class Story {

    private Page[] mPages; //Creating an array of pages to choose from

    public Story(){
        mPages = new Page[7]; //INITIALIZING the array to of pages.

        //This makes page 0(first page) a NEW PAGE OBJECT -
        // WE CAN NOW TREAT THIS AS A PAGE AND USE THE PAGE CLASS' METHODS TO SET PAGE 0'S PROPERTIES
        ...
        //Here, we are using the custom Page constructor to set to properties of the page
        //WE ALSO use the custom Choice constructor
